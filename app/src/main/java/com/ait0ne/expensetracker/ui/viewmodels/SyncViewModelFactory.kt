...
class SyncViewModelFactory(val expensesRepository: ExpensesRepository, val localRepository: LocalRepository): ViewModelProvider.Factory {

    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        return  SyncViewModel(expensesRepository,  localRepository) as T
    }
}